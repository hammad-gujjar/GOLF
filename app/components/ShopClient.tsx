                ...
                <div className="flex flex-col lg:flex-row gap-10 py-10">
                    ...
                    <main className="flex-1">
                        ...
                        {loading ? (
                            ...
                            <>
                                <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-3 gap-x-2 md:gap-x-4 gap-y-6 md:gap-y-10">
                ...
                <div className="max-w-5xl mx-auto flex flex-col gap-16">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                        ...
                        <p className="text-[#EDEEE7]/50 text-base font-light leading-relaxed max-w-sm">
                            Behind every Golf garment lies a rigorous process of selection and refinement. We don't just follow trends; we set the standard for durability and aesthetic longevity.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-1px bg-[#EDEEE7]/10 border border-[#EDEEE7]/10 rounded-[1.5vw] overflow-hidden mt-10">
                        {[
                            ...
                            { title: "Service", desc: "A lifetime commitment to the maintenance of your Golf collection." }
                        ].map((item, i) => (
