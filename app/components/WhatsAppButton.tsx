...
const WhatsAppButton = () => {
    const phoneNumber = '923705276209';
    ...
    return (
        ...
        >
            ...
            {/* Tooltip */}
            <span className="absolute right-full mr-4 px-4 py-2 bg-black text-[#EDEEE7] text-xs font-medium uppercase tracking-widest whitespace-nowrap rounded-md opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-500 pointer-events-none border border-white/10 shadow-2xl">
                Chat with us
            </span>
        </a>
    );
